defmodule OttoLiveWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OttoLiveWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OttoLiveWeb.Gettext, "errors", msg, opts)
    end
  end
